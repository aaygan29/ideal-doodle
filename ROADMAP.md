...
- **Deliverable:** this repo's `README`, `ROADMAP`, `GUIDELINES`, the Council review, the
  literature/math synthesis (in `checkpoints/`).
...
- **Checkpoint C1-DONE:** council review committed; synthetic control runs green.
