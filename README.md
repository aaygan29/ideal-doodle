...
These five survived a full Council-review gate ladder (see `checkpoints/council_review_2026-08-20.md`).
The naive claim "we predict a leader's actions from their neurology" did **not** survive
(Gate 0/6/8 failure) and was inverted into C5.
